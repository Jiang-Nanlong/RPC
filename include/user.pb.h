...
class QueryRequest :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:fixbug.QueryRequest) */ {
 public:
  QueryRequest();
...
class QueryResponse :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:fixbug.QueryResponse) */ {
 public:
  QueryResponse();
...
inline ::google::protobuf::uint32 QueryRequest::id() const {
  // @@protoc_insertion_point(field_get:fixbug.QueryRequest.id)
  return id_;
}
inline void QueryRequest::set_id(::google::protobuf::uint32 value) {
  
  id_ = value;
  // @@protoc_insertion_point(field_set:fixbug.QueryRequest.id)
}
...
inline const ::std::string& QueryResponse::name() const {
  // @@protoc_insertion_point(field_get:fixbug.QueryResponse.name)
  return name_.GetNoArena();
}
inline void QueryResponse::set_name(const ::std::string& value) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:fixbug.QueryResponse.name)
}
#if LANG_CXX11
inline void QueryResponse::set_name(::std::string&& value) {
  
  name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.QueryResponse.name)
}
#endif
inline void QueryResponse::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.QueryResponse.name)
}
inline void QueryResponse::set_name(const void* value, size_t size) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.QueryResponse.name)
}
inline ::std::string* QueryResponse::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:fixbug.QueryResponse.name)
  return name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* QueryResponse::release_name() {
  // @@protoc_insertion_point(field_release:fixbug.QueryResponse.name)
...
inline void QueryResponse::set_allocated_name(::std::string* name) {
  ...
  name_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), name);
  // @@protoc_insertion_point(field_set_allocated:fixbug.QueryResponse.name)
}
